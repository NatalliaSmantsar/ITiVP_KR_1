...
<body class="container py-4">
  <h1 class="mb-3">Wishlist — список желаний</h1>
      ...
      <?php if ($result && $result->num_rows): ?>
        <?php while($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td><?= $row['price'] !== null ? e($row['price']) : '' ?></td>
            <td>
            ...
            <td>
              ...
              <a class="btn btn-sm btn-danger" href="delete.php?id=<?= $row['id'] ?>" onclick="return confirm('Удалить?')">Удалить</a>
